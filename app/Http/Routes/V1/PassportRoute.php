...
class PassportRoute
{
    public function map(Registrar $router)
    {
        $router->group([
            ...
            $router->get ('/auth/social/{provider}', 'V1\\Passport\\AuthController@socialRedirect');
            $router->get ('/auth/social/{provider}/callback', 'V1\\Passport\\AuthController@socialCallback');
            // Comm
