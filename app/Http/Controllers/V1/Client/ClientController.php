        ...
        try {
            ...
            if ($triggerBlock) {
                ...
                if ($bannedStrategy === 'redirect') {
                    $redirectTarget = trim($bannedRedirectUrl);
                ...
                if ($bannedStrategy === 'bait') {
                    $servers = [
                        ...
                        [
                            ...
                            'name' => '🇬🇧 伦敦 01 | 原生IP [流媒体]',
                            'type' => 'shadowsocks',
                            'host' => 'uk01.streaming-unlock.net',
                            'port' => 443,
                            'server_port' => 443,
                            'cipher' => 'aes-128-gcm',
                            'obfs' => null,
                        ...
                        [
                            'id' => 90011,
                            'name' => '🇯🇵 大阪 02 | IEPL [深日专线]',
                            'type' => 'shadowsocks',
                            'host' => 'jp02.iplc-relay.net',
                            'port' => 443,
                            'server_port' => 443,
                            'cipher' => 'chacha20-ietf-poly1305',
                            'obfs' => null,
